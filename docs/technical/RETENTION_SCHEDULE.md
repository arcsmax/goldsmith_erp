...
| `scrap_gold.id_document_type`, `id_document_number`, `id_issuing_authority` (Ausweisdaten, W2-16 / D-16) | Sorgfaltspflicht-Nachweis (GwG) | §8 Abs. 4, §10 Abs. 6a GwG | **5 Jahre** nach Ende der Geschäftsbeziehung (StB) | Verschlüsselte Ausweisfelder hart löschen; übriger Datensatz bleibt unter der Buchungsbeleg-Frist der Zeile darüber | **nein** |
