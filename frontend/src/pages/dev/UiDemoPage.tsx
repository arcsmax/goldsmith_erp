  ...
  return (
    <Section id="overlays" title="Modal, Dialog, Sheet, PromptDialog">
      ...
      <Dialog
        ...
        message="Der Auftrag #1044 wird endgültig gelöscht. Das lässt sich nicht rückgängig machen."
        variant="danger"
        onConfirm={close}
        onCancel={close}
      />

      <Sheet open={open === 'sheet'} onClose={close} title="#1042 Trauringe Gelbgold 585" dismissOnBackdrop>
        <Row>
  ...
  <Section id="fields" title="Field">
    <div className="ui-demo__grid">
      ...
      <Field label="Auftragsnummer" name="demo-disabled">
        <input disabled defaultValue="#1042" />
      </Field>
    </div>
  </Section>
);
