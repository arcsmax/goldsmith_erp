...
async def seed_activities(db, goldsmith_user) -> list:
    ...
    activities_data = [
        ...
        ("Saegen", "fabrication", "icon_saw", "#FF6B6B"),
        ("Feilen", "fabrication", "icon_file", "#4ECDC4"),
        ("Loeten", "fabrication", "icon_flame", "#FF8C42"),
        ("Polieren", "fabrication", "icon_sparkle", "#95E1D3"),
        ("Fassen (Steine)", "fabrication", "icon_gem", "#A8E6CF"),
        ("Gravieren", "fabrication", "icon_pen", "#FFD3B6"),
        ("Emaillieren", "fabrication", "icon_palette", "#FFAAA5"),
        ("Schmieden", "fabrication", "icon_hammer", "#E07A5F"),
        ("Giessen", "fabrication", "icon_cast", "#3D405B"),
        # Administration
        ("Kundenberatung", "administration", "icon_people", "#667EEA"),
        ("Angebot erstellen", "administration", "icon_doc", "#764BA2"),
        ("Dokumentation", "administration", "icon_clipboard", "#5C6AC4"),
        ("Qualitaetskontrolle", "administration", "icon_search", "#006BA6"),
        # Waiting
        ("Warten auf Material", "waiting", "icon_hourglass", "#A0AEC0"),
        ("Pause", "waiting", "icon_coffee", "#CBD5E0"),
    ]
    activities = []
...
async def seed_metal_purchases(db) -> list:
    ...
    purchases_data = [
        ...
        dict(
            ...
            metal_type=MetalType.WHITE_GOLD_18K,
        ...
        dict(
            ...
            metal_type=MetalType.ROSE_GOLD_18K,
...
async def seed_orders(db, customers, users, metal_purchases) -> list:
    ...
    orders_data = [
        ...
        dict(
            ...
            metal_type=MetalType.PLATINUM_950,
            costing_method_used=CostingMethod.SPECIFIC,
...
async def seed_material_usage(db, orders, metal_purchases) -> list:
    ...
    usage_data = [
        ...
        dict(
            ...
            costing_method=CostingMethod.FIFO, used_at=_days_ago(10),
        ),
        ...
        dict(
            ...
            costing_method=CostingMethod.FIFO, used_at=_days_ago(12),
        ),
        ...
        dict(
            ...
            costing_method=CostingMethod.FIFO, used_at=_days_ago(8),
        ),
        ...
        dict(
            ...
            costing_method=CostingMethod.SPECIFIC, used_at=_days_ago(5),
        ),
        ...
        dict(
            ...
            costing_method=CostingMethod.FIFO, used_at=_days_ago(20),
        ),
        ...
        dict(
            ...
            costing_method=CostingMethod.FIFO, used_at=_days_ago(25),
        ),
        ...
        dict(
            ...
            costing_method=CostingMethod.FIFO, used_at=_days_ago(18),
        ),
    ]
    records = []
